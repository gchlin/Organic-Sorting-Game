...
//
// 對話格式：{ who: "hat" | "wiz", text: "…", expr?: "neutral|happy|sad|surprised|thinking|wink|annoyed" }
//   who: "hat" = 分類帽（吐槽 / 講解）；"wiz" = 魔法師（玩家化身，沒有立繪）
//   expr: 分類帽的表情（只對 hat 行有效；wiz 行寫了也忽略）。
//         可用值：neutral / happy / sad / surprised / thinking / wink / annoyed
//         省略則預設 neutral。
//
